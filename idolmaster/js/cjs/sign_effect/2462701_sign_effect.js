...
(lib.sign_effect = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(471.9,589.75,0.9257,0.9257,0,0,0,0.2,0.3);

	this.instance_1 = new lib.glitter_wrapper();
	this.instance_1.parent = this;
	this.instance_1.setTransform(626.25,559.4,0.9257,0.9257,0,0,0,0.2,0.1);
	...
	this.instance_4.setTransform(324.65,597.6,0.6408,0.6408,0,0,0,0.1,0.2);
...
p.nominalBounds = new cjs.Rectangle(608.7,580.8,69.29999999999995,390.1);
// library properties:
lib.properties = {
